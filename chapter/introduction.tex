...
Common symptoms of a \textit{Campylobacter} infection (called campylobacteriosis) include diarrhea, abdominal cramp, nausea, vomiting and fever for a duration of 5-7 days (SOURCE NEEDED). In people with weakened immune systems, such as those with AIDS, or receiving chemotherapy, \textit{Campylobacter} may spread to the bloodstream and cause a life-threatening infection.
