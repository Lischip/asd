...
\begin{itemize}
    \item $\ddfrac{1}{17}$ of the Dutch population gets symptoms from campylobacteriosis in our model. {\color{pink} Why is this valid?}
    \item Most of the causes of campylobacteriosis originate from the envrionment, and not from the consumption of meat. This is conform the literature.
