...
- \texit{Brachycera} can excrete \textit{Campylobacter} spp. on human food. We know that they can excrete \textit{Escherichia coli} for at least 3 days after ingestion \parencite{sasaki_epidemiological_2000}.
...
In the Dutch waters, 37.7\% of the \textit{Campylobacter} strains were attributed to wild birds.


\textcolor{AMAZINGPINK}{dependent variable} \\
\textit{Campylobacter} spp need humid surfaces to live, so surface water is recognised as a key player.

{\huge \textcolor{pink}{Shouldn't there be a link between infected chickens in farms and slauighterhouses and campy in surface water?}}


\textbf{Contaminated surface water}
% Menghua (+ Elias? whoops)
