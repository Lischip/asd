...
%NEW
Lastly, the human population will be split into cohorts of children, working-age and seniors. Although cohorts based on age ranges would provide more accurate representation, the DALY used as this KPI already incorporates age weightings. %REF?
...
Climate change is also linked to different precipitation patterns. An increase in precipitation will result in an increase in 
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{images/Transmission submodel.png}
