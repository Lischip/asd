...
An increase in the size of the Dutch population is not expected to increase the \textit{Brachycera} biomass in the Netherlands \parencite{guenat_effects_2019-1}. Even though an increase in the population leads to more organic waste \parencite{garcia-garcia_framework_2015}, which does have the potential to increase the total number of flies \parencite{imai_population_1984, rozendaal_houseflies_1997}, this effect is possibly counterbalanced by the loss of natural habitat.

%- DEEMED INSIGNIFICANT: more people $\to$ more organic waste \parencite{garcia-garcia_framework_2015} \& more urbanisation $\to$ more \textit{Brachycera} \parencite{imai_population_1984, rozendaal_houseflies_1997} % reason: https://besjournals.onlinelibrary.wiley.com/doi/pdfdirect/10.1111/1365-2664.13270
...
%When French et al., 2009 investigated the wild-bird fecal contamination in playgrounds in parks in a New Zealand city, 12.5% of the samples contained Campylobacter

Both biological disease vectors can excretie \texitt{Campylobacter} on surfaces and human food. It has been shown \textit{Musca domestica} can excrete \textit{Escherichia coli} for at least 3 days after ingestion \parencite{sasaki_epidemiological_2000}. And  12.5\% of the wild-bird feaces samples collected in playgrounds in parks in New Zealand city contained \textit{Campylobacter} \parencite{french
