...
06-04 & 6 & met with group, automated getting the visualisations, met with Elias, met with Emily, helped with gating data from VenSim, moved a large portion of validation to appendix, \& included the current model documentation in report
\end{longtable}
